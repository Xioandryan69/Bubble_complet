...
-- 2. Create the user with your password
CREATE USER roundcube WITH PASSWORD 'TON_MDP';

-- 3. Grant privileges to the user on that database
GRANT ALL PRIVILEGES ON DATABASE roundcube TO roundcube;

-- 4. Grant privileges on the public schema (required for Roundcube)
\c roundcube
